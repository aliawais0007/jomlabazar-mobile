...
export default class SupplierList extends React.Component {
    ...
    fetchProducts = async() => {
        ...
        // search by
        if (search_by && search_by.toLowerCase() === "supplier") {
            API = API + "search_by=3"
        }
    ...
    render() {
        ...
        return (
            ...
            >
                 <View
                    style={{ height: hp("4%"),padding:hp("0.2%"), flexDirection: "row", backgroundColor: mowColors.mainColor, alignItems: "center", justifyContent:"center", color:"white" }}>
                        ...
                        >
                            {this.state.Item ? this.state.Item : "ALL" }
                            </Text>
                            </View>
