        ...
        fetch(API)
            ...
            .then(responseJson => {
                responseJson.map(item => {
                    item['images'] = WomanClothing[0].images;
                    item['stock'] = true;
                    item['currency'] = "$";
                    item['new'] = false;
            ...
            fetch(API)
                ...
                .then(responseJson => {
                    responseJson.map((item,index) => {
                        item['images'] = WomanClothing[index].images;
                        item['stock'] = true;
                        item['currency'] = "$";
                        item['new'] = false;
                        item['discountRate'] = null;
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <View
                    style={{ height: navbarHeight, flexDirection: "row", backgroundColor: mowColors.mainColor, alignItems: "center", justifyContent:"center" }}>
                    ...
                    <MowInput
                        ...
                        placeholder={`Search ${this.state.Item}'s here`}
                ...
                {isFetched && productLength < 1 &&
                    <View style={{ justifyContent: "center", alignItems: "center", height: hp(80) }}>
                        <Text>No {this.state.Item} available</Text>
                    </View>
                }
